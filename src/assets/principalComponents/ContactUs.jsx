...
export default function ContactUs() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSending(false);
      // Traducir mensajes de error del backend a español
      const errorMessage = err.detail || err.message || "";
      const spanishError = errorMessage.includes("Failed to send message")
        ? "Error al enviar el mensaje. Por favor, intenta nuevamente más tarde."
        : err.detail ||
          "Error al enviar el mensaje. Por favor, intenta contactarnos por WhatsApp.";
      ...
      <div className="max-w-7xl mx-auto mb-16">
        ...
        >
          ...
          <p className="text-base-content/70 text-lg font-light max-w-2xl mx-auto">
            Estamos aquí para ayudarte. Visítanos en nuestras tiendas o
            contáctanos por los medios que prefieras.
          </p>
        </motion.div>
      </div>
            ...
            {sent ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text font-light tracking-wide">
                          NOMBRE
                        </span>
                      </label>
                      <input
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text font-light tracking-wide mr-2">
                        TELÉFONO (OPCIONAL)
                      </span>
                    </label>
                    <input
